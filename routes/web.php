...
Route::group(['middleware' => 'Revalidate'],function() {
    Route::group(['middleware' => 'Authenticate'], function () {
        ...
        Route::post('/permission/permissionasign/{id}', ['as' => 'permission.permissionasign', 'uses' => 'backend\PermissionController@permissionasign']);
         ...
         Route::post('/module_permission/asign/{id}', ['as' => 'moudule_permission.permissionasign', 'uses' => 'backend\ModuleController@permissionasign']);
         
         Route::post('/module_permission/permissionasign/{id}', ['as' => 'module_permission.permissionasign', 'uses' => 'backend\ModuleController@permissionasign']);
        ...
        Route::get('/sales-update/{id}', ['as' => 'sales.update', 'uses' => 'backend\SalesController@update']);
