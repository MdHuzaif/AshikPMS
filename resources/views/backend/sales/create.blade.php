                        ...
                        <div class="x_content">
                            <form id="btnSave" action="{{route('sales.store')}}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"  class="form-control" id="customer_name" name="sales_quantity" placeholder="Customer Name and Contact No." >
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="radio" name="sales_status" id="deactive" value="0"><label for="deactive"> Credit </label>
