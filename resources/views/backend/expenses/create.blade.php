                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    <a href="{{route('expensesheading.create')}}" class="btn btn-primary mb1 bg-red">Add Category </a>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="input-group">
                                    <a href="{{route('expenses.list')}}" class="btn btn-primary mb1 bg-red">View expenses</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="x_content">
                            <form action="{{route('expenses.store')}}" method="post">
                                ...
                                <div class="box-footer">
                                    <button type="submit" name="btnSave" class="btn btn-danger" > Save Expense </button>
                                </div>
                            </form>
                        </div>
                    </div>
